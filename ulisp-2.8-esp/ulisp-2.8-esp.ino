/*  uLisp ESP Version 2.8 - www.ulisp.com
    ...
    Updated to uLisp 2.6 Kaef, 10th, April 2019
*/
...
unsigned int saveimage (object *arg) {
    ...
    if (!file) error2(0, PSTR("problem saving to SD card"));
...
unsigned int loadimage (object *arg) {
    ...
    else error2(LOADIMAGE, PSTR("illegal argument"));
    if (!file) error2(0, PSTR("Problem loading from SD card"));
    SDReadInt(file);
...
void welcomeMessage () {
    pln(pserial); pfstring(PSTR("uLisp 2.8 (Kaef)"), pserial); pln(pserial);
