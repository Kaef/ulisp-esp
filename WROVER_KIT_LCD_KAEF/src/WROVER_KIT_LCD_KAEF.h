...
/* Kaef, 2019-03-15:
   - changed constructor (added SPIClass as a parameter)
   - replaced all occurences of 'SPI.' with 'tftSPI->' in cpp file
*/

#ifndef _WROVER_KIT_LCD_KAEF_H_
#define _WROVER_KIT_LCD_KAEF_H_
...
class WROVER_KIT_LCD_KAEF : public Adafruit_GFX {
    protected:

    public:
        WROVER_KIT_LCD_KAEF(SPIClass useSPI); // Kaef
        virtual ~WROVER_KIT_LCD_KAEF(){}
